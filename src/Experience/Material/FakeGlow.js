...
class FakeGlowMaterial extends ShaderMaterial {
   ...
   * @param {number} [parameters.falloff=1.0] - The falloff factor for the glow effect.
   * @param {number} [parameters.glowInternalRadius=0.0] - The internal radius for the glow effect.
   * @param {Color} [parameters.glowColor=new Color('#00d5ff')] - The color of the glow effect.
   * @param {number} [parameters.glowSharpness=1.0] - The sharpness of the glow effect.
   * @param {number} [parameters.opacity=0.2] - The opacity of the hologram.
   * @param {number} [parameters.side=THREE.DoubleSide] - The rendering side. Use `THREE.FrontSide`, `THREE.BackSide`, or `THREE.DoubleSide`.
